...
<div class="fixed inset-0 z-50 overflow-y-auto"
    ...
    <div class="flex min-h-full items-center justify-center p-4 text-center"
        x-on:click.stop>
        <div
            class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all w-full max-w-3xl">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col space-y-4">
                        <label for="image-upload-create-new"
                            ...
                            <span
                                class="text-gray-700 font-medium group-hover:text-blue-600 transition-colors">Add
                                Photos</span>
                            <input type="file"
                        ...
                        <div id="image-preview-create-new"
                            ...
                            <template x-for="(image, index) in displayImages"
                                :key="image.tempId || image.url">
                                <div
                                    class="image-container relative group transform transition-transform hover:scale-[1.02] duration-200">
                                    <img :src="image.url"
                                    ...
                                    <div
                                        ...
                                        <button type="button"
                                            ...
                                            class="remove-image opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-red-600 hover:bg-red-700 text-white rounded-full p-1.5 z-10 transform hover:scale-110">
                                            <svg class="h-5 w-5 pointer-events-none"
                                                viewBox="0 0 20 20"
                                                fill="currentColor">
                                                <path fill-rule="evenodd"
                                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 0 111.414 1.414L11.414 10l4.293 4.293a1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 0 010-1.414z"
                                                    clip-rule="evenodd" />
                                            </svg>
                                        </button>
                                    </div>
